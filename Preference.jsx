...
render(){    
  return (
    <div className="App" style={{background: "#fff", height: "100%", padding: "20px 20px 100px 20px", flex: 1}}>  
        ...
        <strong><h5 style={{fontWeight: "700", marginTop: 20}}>Preferences</h5></strong> 
        <Container>
            <p style={{fontSize: 10, marginTop: 30}}>Currency</p>
            <Row style={{marginTop: 0, background: "#F0F0F0", justifyContent: "flex-start", height: "auto", padding: 2, borderRadius: 5}}>
                
                <Col xs={8}>
                    <form>
                        <select style={{background: "transparent", border: "0px", width: 300}} className="form-control">
                            <option value="AICB Naira">AICB Naira</option>
                        </select>
                    </form>
                </Col>
            ...
            <p style={{fontSize: 10, marginTop: 30}}>Notifications</p>
            <Row style={{marginTop: 0, background: "#F0F0F0", justifyContent: "flex-start", height: "auto", padding: 2, borderRadius: 5}}>
                
                <Col xs={8}>
                    <form>
                        <select style={{background: "transparent", border: "0px", width: 300}} className="form-control">
                            <option value="AICB Naira">In-App Only</option>
                        </select>
                    </form>
                </Col>
                <Col xs={1} style={{alignContent: "flex-end"}}>
