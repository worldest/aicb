...
render(){    
  return (
    <div className="App" style={{background: "#fff", height: "100%", padding: "20px 20px 100px 20px", flex: 1}}>  
        ...
        <strong><h5 style={{fontWeight: "700", marginTop: 20}}>Price Alert</h5></strong> 
        <Container>
           
           <Row style={{marginTop: 15, background: "#F0F0F0", justifyContent: "flex-start", height: "auto", padding: 2, borderRadius: 5}}>
                
                <Col xs={10}>
                    <p style={{fontWeight: "700", marginTop: 14, fontSize: 14}}>Allow Price Alert</p>
                    <p style={{fontWeight: "400", marginTop: 0, fontSize: 9}}>Get alerts for significant price changes of  cryptocurriencies in your portfolio and watchlist.</p>
                </Col>
