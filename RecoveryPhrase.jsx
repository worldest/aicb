...
function App() {
    document.addEventListener("DOMContentLoaded", function(){
        ...
        while(i <= 12){
            ...
            var randomKey = localStorage.getItem("key" + i);
  ...
  return (
    <div className="App">   
        ...
        <Row>
          <Col className="col-md-12">
            ...
            <div className="btn-div">
              <center>
                <p style={{fontSize: 13,fontWeight: "200", textAlign: "left", paddingLeft: 40, paddingRight: 40}}>
                    <span className="fa fa-info-circle" style={{fontSize: 15}}></span> Never share your recovery phrase with anyone, store it securely!
                </p>
      ...
      <br /><br /><br />
      <center>
      <button onClick={copyKeys} className="btn" style={{border: 0, background: "#fff", marginTop: -40}}>Copy <span className="fa fa-copy"></span></button>
      </center>
