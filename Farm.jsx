...
render(){    
  return (
    <div className="App desktop-header" style={{background: "#fff", height: 1000, padding: "0px 0px 100px 0px", flex: 1}}>  
        ...
        <Container style={{background: "#7CC5E3", padding: 20}}>
            <Link to="./swap"><span className="fa fa-arrow-left" style={{color: "#fff"}}>

            </span></Link>
            <br />
            <h6 style={{marginTop: 10}}>Farm</h6>
            <p style={{fontSize: 12, marginTop: -5}}>Stake  Liquity Pool (LP) to earn</p>
        ...
        <p style={{color: "#000", fontSize: 12, fontWeight: "800", marginTop: 10}}>Preferences</p>
            ...
            <div style={{background: "#fff", width: "90%", border: "2px solid #2A0E59", borderRadius: 3, margin: "10px auto", padding: "10px 5px 10px 5px", boxShadow: "1px 1px 11px 1px #eee"}}>
                <p style={{color: "#000", fontSize: 16, fontWeight: "800", marginTop: 10}}>AICB-BNB</p>
                        <div className="row">
                            <div className="col-10">
                                <p style={{color: "#000", fontSize: 12, fontWeight: "100", marginBottom: 0}}>Earned</p>
                        ...
                        <div className="row" style={{marginTop: 10}}>
                            ...
                            <div className="col-4">
                            <p style={{color: "#000", fontSize: 12, float: "right", fontWeight: "100", marginBottom: 0}}>79.6%</p>
                            </div>
                        </div>
                        
                        <div className="row" style={{marginTop: 10}}>
                            <div className="col-8">
                                <p style={{color: "#000", fontSize: 12, fontWeight: "100", marginBottom: 0}}>Liquidity</p>
                                
                            </div>
                            
                            <div className="col-4">
                            <p style={{color: "#000", fontSize: 12, float: "right", fontWeight: "100", marginBottom: 0}}>$965.897,897</p>
                            </div>
                        </div>
                        <div className="row" style={{marginTop: 10}}>
                            <div className="col-10">
                                <p style={{color: "#000", fontSize: 12, fontWeight: "100", marginBottom: 0}}>Multiplier</p>
                                
                            </div>
                            
                            <div className="col-2">
                            <p style={{color: "#000", float: "right", fontSize: 12, fontWeight: "100", marginBottom: 0}}>40x</p>
                            </div>
                        </div>
                        <br />
                        <div className="row" style={{marginTop: 10}}>
                            <div className="col-10">
                                <p style={{color: "#000", fontSize: 12, fontWeight: "100", marginBottom: 0}}>Get AICB-BNB LP</p>
                        ...
                        <div className="row" style={{marginTop: 10}}>
                            <div className="col-10">
                                <p style={{color: "#000", fontSize: 12, fontWeight: "100", marginBottom: 0}}>View Contract</p>
                        ...
                        <div className="row" style={{marginTop: 10}}>
                            <div className="col-10">
                                <p style={{color: "#000", fontSize: 12, fontWeight: "100", marginBottom: 0}}>See Pair Info</p>
                        ...
                        <br /><br />
                        <p style={{color: "#000", fontSize: 16, fontWeight: "800", marginTop: 10}}>AICB Earned</p>
                        
                                <form style={{ display: "inline"}}>
                                    <input style={{padding: 10, width: "50%", display: "inline", background: "#f0f0f0", height: 40,}} value="0.0" className="form-control"></input>
                                </form>
                            
                                <button className="btn btn-primary" style={{background: "#BA36E5", display: "inline",padding: 10, marginLeft: 13, height: 40, width: "45%"}}>Harvest</button>
                        ...
                        <center>
                            ...
                            }} style={{width: "100%", display: "inline-block", marginTop: 10}} className="btn btn-primary">ENABLE FARM</button>
                        </center>
                    </div>
                    <center>
                    <form style={{width: "90%", padding: 15, border: "2px solid #000", marginTop: 10}}>
                        <select style={{width: "100%", border: "0px", fontWeight: "bold"}}>
                            <option>AICB-BNB</option>
                        </select>
                    </form>
                    </center>
