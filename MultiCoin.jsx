...
render(){    
  return (
    <div className="App" style={{background: "#fff", height: "100%", padding: "20px 20px 100px 20px", flex: 1}}>  
        <Link to="/wallet-settings"><span className="fa fa-arrow-left" style={{color: "#000", fontSize: 19}}></span></Link>      
        <strong><h5 style={{fontWeight: "700", marginTop: 20}}>Wallet</h5></strong> 
        <strong><h5 style={{fontWeight: "200",fontSize: 12}}>Wallet Name</h5></strong>  
        <Container>
            <Row style={{marginTop: 15, background: "#F0F0F0", justifyContent: "flex-start", height: "auto", padding: 2, borderRadius: 5}}>
                
                <Col xs={8}>
                    <p style={{fontWeight: "700", marginTop: 14, fontSize: 14}}>Multi-Coin Wallet 1</p>
                </Col>
                <Col xs={1} style={{alignContent: "flex-end"}}>
                   
                </Col>    
            </Row>   
            <Link to="/confirm-show-recovery" style={{color: "#000"}}><Row style={{marginTop: 15, background: "#F0F0F0", justifyContent: "flex-start", height: "auto", padding: 2, borderRadius: 5}}>
                
                <Col xs={10}>
                    <p style={{fontWeight: "700", marginTop: 14, fontSize: 14}}>Show Recovery Phrases</p>
                </Col>
                <Col xs={1} style={{alignContent: "flex-end"}}>
